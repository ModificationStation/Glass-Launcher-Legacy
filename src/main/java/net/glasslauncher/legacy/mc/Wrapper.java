...
public class Wrapper {
    ...
    public Wrapper(String[] launchArgs) {
        ...
        String instPath = Config.GLASS_PATH + "instances/" + instance + "/.minecraft";
        ...
        args.add("-jar");
        args.add(Config.GLASS_PATH + "lib/" + Config.getEasyMineLauncherFile());
    ...
    private void getConfig() {
        String instPath = Config.GLASS_PATH + "instances/" + instance;
    ...
    public void startMC() {
        ...
        String newAppData = Config.GLASS_PATH + "instances/" + instance;

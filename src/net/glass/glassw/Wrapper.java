...
import net.glass.glassl.WidgetArrayList;
...
public class Wrapper extends Applet implements AppletStub {
    ...
    private static WidgetArrayList widgetlist;

    public static void main(String[] args, WidgetArrayList widgetlist) {
    ...
    private void play() {
        final String mcpath = Config.instpath + "instances/" + instance;
        ...
        try {
            ...
            BufferedImage img = ImageIO.read(Wrapper.class.getResourceAsStream("assets/favicon.ico"));
    ...
    */
    ...
    private static void makeLogger() {
        try {
            ...
            File logdir = new File(Config.instpath + "/glass-logs/wrapper");
            logdir.mkdirs();
            Handler file_handler = new FileHandler(Config.instpath + "/glass-logs/wrapper/" + time + ".log");
